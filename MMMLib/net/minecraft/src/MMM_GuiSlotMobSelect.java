...
public class MMM_GuiSlotMobSelect extends GuiSlot {
	...
	protected void drawSlot(int var1, int var2, int var3, int var4, Tessellator var5) {
		// 基本スロットの描画、細かい所はオーナー側で, Drawing of basic slot, small place in the owner side
		// Entityの確保, Ensure the Entity
		String s = ownerGui.entityMap.keySet().toArray()[var1].toString();
...
//		GL11.glEnable(32826 /* GL_RESCALE_NORMAL_EXT */);
		...
		// 影だかバイオームだかの処理?, Processing or a biome or a shadow?
		GL11.glPopMatrix();
